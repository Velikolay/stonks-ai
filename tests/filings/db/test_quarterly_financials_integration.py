...
class TestQuarterlyFinancialsIntegration:
    ...
    async def test_view_exists(self, db):
        ...
        result = await db.quarterly_financials.get_quarterly_financials(filter_params)
        assert isinstance(result, list)


class TestQuarterlyFinancialsFilterCreation:
    """Sync tests for filter creation (no asyncio)."""
    ...
    async def test_view_structure(self, db):
        ...
        q1_result = await db.quarterly_financials.get_quarterly_financials(q1_filter)
        ...
        q3_result = await db.quarterly_financials.get_quarterly_financials(q3_filter)
        ...
        q4_result = await db.quarterly_financials.get_quarterly_financials(q4_filter)
